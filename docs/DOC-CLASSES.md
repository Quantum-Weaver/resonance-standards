...
| **SEED** | Copied once into a repo, then **diverges on purpose** — it becomes the repo's own. | `.gitignore-template`, HANDOFF-TEMPLATE | **Never.** A seed is a planting, not a mirror; overwriting one destroys repo-specific truth. |
